...
const Order: React.FC<IProps> = ({ setLoadingExport, setLinkExport, setIsExport }) => {
            ...
            <Spin spinning={loading}>
                <div className="flex justify-between flex-wrap items-start">
                    <div>
                        ...
                        <div className="mt-1.75 text-davy-grey text-3.75 font-semibold mr-2">Order Total</div>
                    </div>
